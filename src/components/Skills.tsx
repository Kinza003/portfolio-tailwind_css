    ...
    <div id='skills' className='container pt-32'>
      <div className='grid md:grid-cols-2 gap-20'>
        <div data-aos="zoom-in-down">
          <h2 className='text-4xl md:text-5xl text-black font-semibold italic'>Technologies I work with</h2>
        ...
        <div>
          <div className='grid grid-cols-2 text-fuchsia-500 text-3xl sm:text-4xl'>
            <div className='space-y-2 lustiana'>
